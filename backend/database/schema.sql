...
SELECT * FROM (
  ...
  -- ============ 系统分析师 (subject_id=9) ============
  -- 综合知识 (sub_subject_id=4) - 9 章
  SELECT  27,         9,                4,                   0,             '绪论',                                        1 UNION ALL
  SELECT  28,         9,                4,                   0,             '数学与工程基础',                              2 UNION ALL
  SELECT  29,         9,                4,                   0,             '计算机系统',                                  3 UNION ALL
  SELECT  30,         9,                4,                   0,             '计算机网络与分布式系统',                      4 UNION ALL
  SELECT  31,         9,                4,                   0,             '数据库系统',                                  5 UNION ALL
  SELECT  32,         9,                4,                   0,             '企业信息化',                                  6 UNION ALL
  SELECT  33,         9,                4,                   0,             '软件工程',                                    7 UNION ALL
  SELECT  34,         9,                4,                   0,             '项目管理',                                    8 UNION ALL
  SELECT  35,         9,                4,                   0,             '信息安全',                                    9 UNION ALL
